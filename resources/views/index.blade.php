                ...
                <div class="col-xl-5 offset-xl-7 col-lg-8 offset-lg-2 col-md-10 offset-md-1">
                    <div class="hero-content">
                        ...
                        <p class="wow fadeInUp" data-wow-delay=".4s">Selamat datang di Website Peminjaman Ruang Terbaik di
                            Universitas Sultan Ageng Tirtayasa. Temukan, pesan, dan gunakan ruang kampus dengan mudah</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="hero-left">
            <img src="assets/images/untircoyyy.jpg" alt="" style="width: 734px; height: 979px; object-fit: cover; display: block;">
